...
class _LandingScreenState extends State<LandingScreen> {
  ...
  String _currentView = 'landing'; // landing, admin-login
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            // Header
            if (_currentView != 'admin-login') _buildHeader(),
            
            // Main Content
            Expanded(
              child: _currentView == 'landing' 
                ? _buildLandingView()
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          TextButton.icon(
                            onPressed: () => setState(() => _currentView = 'admin-login'),
  ...
  Widget _buildAdminLoginView() {
    return AdminScreen(
      onBack: () => setState(() => _currentView = 'landing'),
    );
  }
